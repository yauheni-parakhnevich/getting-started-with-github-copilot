...
activities = {
    ...
    "Basketball Team": {
        "description": "Train for competitive basketball games and build team skills",
    ...
    "Swimming Club": {
        ...
        "max_participants": 18,
        "participants": ["noah@mergington.edu", "avani@mergington.edu"]
    },
    "Art Club": {
        "description": "Create visual art projects and explore different artistic media",
    ...
    "Science Olympiad": {
        ...
        "max_participants": 18,
        "participants": ["sara@mergington.edu", "logan@mergington.edu"]
    },
    "Debate Team": {
        "description": "Develop public speaking and argumentation skills for debate events",
